...
class TestTransaction(BaseTestCase):
    ...
    def test_verify(self):
        ...
        self.assertTrue(response['status'])
money_transaction = TestTransaction()
money_transaction.test_initialize()
money_transaction.test_charge()
res = money_transaction.test_charge_token()
print(res)
